...
- **La Escalera** (liga permanente — fase 1 ✅ terminada) — PRP en [`docs/PRPs/la-escalera-prp.md`](../PRPs/la-escalera-prp.md) + roadmap en [`docs/PRPs/la-escalera-roadmap.md`](../PRPs/la-escalera-roadmap.md). Borradores originales en [`docs/new-features/`](../new-features/). Decisión arquitectónica clave en [ADR 0001](../adr/0001-match-polimorfico-escalera.md). Ranking ELO único; 4 fases: ~~fundación~~ → retos+ELO → compromiso → gamificación.
