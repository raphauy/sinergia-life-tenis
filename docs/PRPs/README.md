...
Cada **feature nueva** tiene aquí dos archivos:
...
Convención de nombre: `kebab-case`, sin prefijo numérico. Ejemplo: `la-escalera-prp.md`, `la-escalera-roadmap.md`.

> El MVP ya construido **no** tiene PRP retroactivo: su spec histórica vive en [`docs/prd.md`](../prd.md) (fuente de verdad del producto base). El flujo PRP/roadmap aplica a las features que vienen **después** del MVP.
...
4. Antes de dar la fase por terminada: `/revisar` + `pnpm typecheck` + `pnpm build`.
