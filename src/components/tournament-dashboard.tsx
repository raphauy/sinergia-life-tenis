...
import { getActiveTournament, getTournamentBySlug } from '@/services/tournament-service'
...
import { getPlayerMapByCategory } from '@/services/player-service'
...
type DashboardTournament =
  | NonNullable<Awaited<ReturnType<typeof getActiveTournament>>>
  | NonNullable<Awaited<ReturnType<typeof getTournamentBySlug>>>

export async function TournamentDashboard({
  tournament,
  currentUserId,
  currentPlayerSlug,
}: {
