...
- Respetar las convenciones del proyecto declaradas en `CLAUDE.md` (services como única capa Prisma, server actions sobre API routes, Next.js 16 con `proxy.ts`, timezone UTC en BD / UY en UI, español con tildes, etc.).
